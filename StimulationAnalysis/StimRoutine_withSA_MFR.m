...
listOfGroups = xlsx2mat_grouping('sheetname', 'KRAS007_groupedmouse', 'nbGroups',8 ,...
 'variableNames',{'ms1_wT','ms2_KI','ms3_KI','ms4_wT','ms5_KI','ms6_wT','ms7_KI','ms6_KI'}); 
...
for s = 1:nbSessions
    ...
    [MFRrel, MFRSA] = StimAnalysis_SA_MFR (fileData,fileStim,SAInfo,basePath,StimPath,validList, validWells,MFRstore,1); % 1 = not stim wells are not discarded
    MFRdata(:,:,s) = MFRrel;  
    MFRdataSA(:,:,s) = MFRSA;
