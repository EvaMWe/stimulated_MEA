function stimResult =StimRoutine_withSA(varargin)
%% *******************Read In Data:******************************
...
% GROUPING LIST (EXCEL FILE) 
% NOTE***CODE HERE HAS TO BE MODIFIED BY USER******
%START MODIFICATION PART
listOfGroups = xlsx2mat_grouping('sheetname', 'KRAS007_groupedmouse', 'nbGroups', 8 ,...
  'variableNames',{'ms1_wT','ms2_KI','ms3_KI','ms4_wT','ms5_KI','ms6_wT',...
  'ms7_KI','ms8_KI'});
...
for s = 1:nbSessions
    ...
    %fileSA = SAInfo(1,[1 2 3]);
    result = StimAnalysis_SA(fileData,fileStim,basePath,StimPath,validList, validWells,1); % 1 = not stim wells are not discarded
